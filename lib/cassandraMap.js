/* Cassandra-compilant MAP v0.1.5 | Adapted by jcoc611 | Based on the following: */
...
(function () {
	...
	var root = objectTypes[typeof window] && window || this;
			// freeGlobal = exports && objectTypes[typeof module] && module && !module.nodeType && typeof global == "object" && global;

	// if (freeGlobal && (freeGlobal["global"] === freeGlobal || freeGlobal["window"] === freeGlobal || freeGlobal["self"] === freeGlobal)) {
	// 	root = freeGlobal;
	// }
	// Use Exports as default:
	if(freeExports) root = freeExports;
	...
	root["cassandraMAP"] = {};
	runInContext(root, root["cassandraMAP"]);
